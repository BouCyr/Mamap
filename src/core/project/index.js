// Projection stage (see docs/PROJECT_PLAN.md, phase 8).
//
...
// fills in 2D map coordinates. This is the boundary between core
// generation and rendering — nothing 3D should be left in its output.
//
